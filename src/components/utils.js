...
function isDeepEqual(o1, o2, depth = 0) {
    ...
    for (let k of o1Keys) {
        ...
        if (nestedO && depth < MAX_DEPTH) {
            diffs.push(isDeepEqual(o1[k], o2[k], depth + 1));
        } else {
 ...
 * @param {Object} clone - carries the cloned output throughout the
 * recursive calls. Parameter serves only for internal usage.
 * @param {number} depth - this parameter serves only for internal usage.
 * @returns {Object} - the cloned object.
 * @memberof utils
 */
function deepClone(o, clone = {}, depth = 0) {
    ...
    for (let k of oKeys) {
        ...
        clone[k] = nested && depth < MAX_DEPTH ? deepClone(o[k], {}, depth + 1) : o[k];
    }
 ...
 * @param  {int} [depth=0] - the depth at which we are merging the object.
...
function merge(o1 = {}, o2 = {}, depth = 0) {
    ...
    for (let k of Object.keys(o1)) {
        const nestedO = !!(o2[k] && typeof o2[k] === "object" && typeof o1[k] === "object" && depth < MAX_DEPTH);

        if (nestedO) {
            const r = merge(o1[k], o2[k], depth + 1);
